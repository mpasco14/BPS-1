...
class ExitDryRunContract:
    """
    Safe dry-run contract for exit planning.

    This object only describes what the system would do.
    It must never submit, cancel, modify, or route real orders.
    """
